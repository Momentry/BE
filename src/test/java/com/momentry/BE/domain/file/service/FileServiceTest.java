...
public class FileServiceTest {
    ...
    @Test
    @DisplayName("실제 S3 버킷에 이미지 업로드 및 압축 테스트")
    void uploadFileToS3Test() throws IOException {
        ...
        String filePath = "src/test/resources/test.jpg"; // 테스트용 이미지를 이 경로에 두세요!
        ...
        Long testAlbumId = 1L;
        FileResult result = fileService.uploadFile(testAlbumId, mockFile, metadata, LocalDateTime.now());
